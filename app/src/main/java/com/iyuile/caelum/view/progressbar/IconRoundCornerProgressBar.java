...
package com.iyuile.caelum.view.progressbar;
...
import com.iyuile.caelum.view.progressbar.common.BaseRoundCornerProgressBar;
...
public class IconRoundCornerProgressBar extends BaseRoundCornerProgressBar implements View.OnClickListener {
    ...
    protected void initStyleable(Context context, AttributeSet attrs) {
        ...
        iconResource = typedArray.getResourceId(R.styleable.IconRoundCornerProgress_rcIconSrc, R.mipmap.ic_launcher);
