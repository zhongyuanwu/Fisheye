...
/**
 * 阴影布局
 * {@links https://github.com/dmytrodanylyk/shadow-layout}
 * <p/>
 * Created by WangYao on 2016/12/6.
 */
public class ShadowLayout extends FrameLayout {
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShadowColor = attr.getColor(R.styleable.ShadowLayout_sl_shadowColor, ContextCompat.getColor(context, R.color.default_shadow_color));
        } finally {
            attr.recycle();
        }
    }
