...
/**
 * {@links https://github.com/alamkanak/android-empty-layout}
 */
public class ListView2EmptyLayout {
    ...
    private void changeEmptyType() {
        ...
        if (mListView != null) {
            ...
            if (mLoadingAnimationViewId > 0)
                loadingAnimationView = mLoadingView.findViewById(mLoadingAnimationViewId);
            switch (mEmptyType) {
                case TYPE_EMPTY:
    ...
    private void setDefaultValues() {
        if (mEmptyView == null) {
            mEmptyView = (ViewGroup) mInflater.inflate(R.layout.listview_view_empty, null);
        ...
        if (mLoadingView == null) {
            mLoadingView = (ViewGroup) mInflater.inflate(R.layout.listview_view_loading, null);
        ...
        if (mErrorView == null) {
            mErrorView = (ViewGroup) mInflater.inflate(R.layout.listview_view_error, null);
     ...
     */
    public ListView2EmptyLayout(Context context, AbsListView listView) {
        mContext = context;
    ...
    private void initDefault() {
        mErrorMessage = mContext.getString(R.string.listview_2_error_message);
        mEmptyMessage = mContext.getString(R.string.listview_2_empty_message);
        mLoadingMessage = mContext.getString(R.string.listview_2_loading_message);
    }
