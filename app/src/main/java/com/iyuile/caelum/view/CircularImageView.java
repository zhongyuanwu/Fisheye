 ...
 * @author WangYao
 * @version 1
 * @Description {@links https://github.com/lopspower/CircularImageView}
 * @date 2015-10-20 18:31:31
 */
public class CircularImageView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(circleCenter + borderWidth, circleCenter
                + borderWidth, circleCenter + borderWidth - 4.0f, paintBorder);
        canvas.drawCircle(circleCenter + borderWidth, circleCenter
    ...
    private void updateShader() {
        ...
        if (!isInEditMode()) {
            BitmapShader shader = new BitmapShader(Bitmap.createScaledBitmap(
                    ThumbnailUtils.extractThumbnail(image, canvasSize, canvasSize),
